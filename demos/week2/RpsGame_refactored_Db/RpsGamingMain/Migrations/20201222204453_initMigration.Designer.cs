...
namespace RpsGame_refactored_Db.Migrations
{
    ...
    [Migration("20201222204453_initMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RpsGame_refactored_Db.Match", b =>
                {
            ...
            modelBuilder.Entity("RpsGame_refactored_Db.Player", b =>
                {
            ...
            modelBuilder.Entity("RpsGame_refactored_Db.Round", b =>
                {
            ...
            modelBuilder.Entity("RpsGame_refactored_Db.Match", b =>
                {
                    b.HasOne("RpsGame_refactored_Db.Player", "Player1")
                        .WithMany()
                        .HasForeignKey("Player1PlayerId");

                    b.HasOne("RpsGame_refactored_Db.Player", "Player2")
                        .WithMany()
            ...
            modelBuilder.Entity("RpsGame_refactored_Db.Round", b =>
                {
                    b.HasOne("RpsGame_refactored_Db.Player", "WinningPlayer")
                        .WithMany()
